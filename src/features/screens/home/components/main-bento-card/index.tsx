...
const MainBentoCard = () => {
  return (
    <div className="bg-[#D1E8C4] rounded-[32px] p-6 mb-4 relative">
      ...
      <h2 className="text-[2.5rem] font-medium leading-[1.1] tracking-tight mb-8 dark:text-neutral-800">
        You have 3<br />
        tasks{" "}
        <span className="inline-flex items-center px-2 py-0.5 rounded-full border border-red-400/30 text-red-500 text-sm font-medium align-middle mx-1 bg-red-50/50">
          High ~
        </span>{" "}
        for today
      </h2>
