    ...
    return (
        <div className="bg-white rounded-[32px] p-4 mb-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
                <div className="w-15 h-15 rounded-full bg-neutral-900 text-white flex flex-col items-center justify-center leading-none">
                    <span className="text-xl font-medium">11</span>
                    <span className="text-[10px] font-medium text-neutral-400 mt-1">AM</span>
                </div>
                <div>
                    <h3 className="font-semibold text-lg flex items-center gap-2 dark:text-neutral-700">
