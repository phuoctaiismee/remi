    ...
    return (
        <div className="bg-[#FDF1B0] rounded-[32px] p-6 mb-4">
            <div className="flex justify-between items-center mb-6">
                <h3 className="font-semibold text-lg dark:text-neutral-700">Set Reminder</h3>
            ...
            <div className="flex justify-between items-center bg-white/60 rounded-[24px] p-5">
                <div className="text-4xl font-medium tracking-tighter dark:text-neutral-800">14:30</div>
